...
class PendingDates extends StatefulWidget {
  @override
  _PendingDatesState createState() => _PendingDatesState();
}

class _PendingDatesState extends State<PendingDates> {
  @override
      ...
      itemBuilder: (BuildContext context, int position) {
        return Column(
          children: [
            ...
            Align(alignment: Alignment.centerRight, child: divider(Colors.grey[300], 120.0, 0.80),),
